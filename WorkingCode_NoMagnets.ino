...
const uint16_t currentLimits[numOfSteppers] = {1500, 1500, 1500, 1500, 1500, 1500, 2000, 1500, 1500}; //Current limits per motor (mA)
...
int totalPicks = 600;    //Change this to choose fabric length  
int currentPick = 36;   //Do not change, always 1
...
int harnessHome = 2435; //2365 //Steps from harness switch to neutral plane
...
void beatUp(){
  ...
  delay(1000); //pause to let vibrations die down
  moveBeatUp(-beatupDistance);
}
